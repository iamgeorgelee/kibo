...
module.exports = function(passport) {
    ...
    passport.deserializeUser(function(id, done) {
        ...
        //     return iterateUser._id.$oid == id.$oid;
        // })[0];
        ...
        performrequest.performRequest('/api/1/databases/kibo/collections/User/'+id, 'GET', {
                apiKey: apiKey
            }, function(data) {
                done(null, data);
            }
    ...
    function(req, username, password, done) {
        ...
        process.nextTick(function() {
            ...
            var user = Users.filter(function(iterateUser) {
                return iterateUser.name == username;
            })[0];
            ...
            if (user) {
                ...
                performrequest.performRequest('/api/1/databases/kibo/collections/User?apiKey=necMvEqo9wdApurqW9z5c-80Jz04T_uX', 'POST', {
                        name: username,
...
// generating a hash
function generateHash(userPassword, next) {
    bcrypt.hash(userPassword, bcrypt.genSaltSync(8), null, next);
}
